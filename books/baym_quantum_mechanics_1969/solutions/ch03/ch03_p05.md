...
5. What is $[y_{\text{op}}, (p_x)_{\text{op}}]$? Compare these commutation relations for position and momentum with the classical Poisson bracket relations satisfied by $\mathbf{p}$ and $\mathbf{r}$.
