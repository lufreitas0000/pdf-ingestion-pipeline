---
problem_id: baym_quantum_mechanics_1969_ch01_p01
...
**Source**: Chapter 1, Problem 1

## Problem Statement

1. A man sends a beam of red light along the z axis through a polaroid filter that passes only x polarized light. The beam is initially polarized at 30° to the x axis, and the total energy content of the beam is quite accurately 10 joules. Estimate the fluctuations in the energy of the beam, i.e., the range of likely energy values, after it passes through the polaroid. How do the fluctuations depend on $\hbar$?
