---
problem_id: baym_quantum_mechanics_1969_ch01_p04
...
**Source**: Chapter 1, Problem 4

## Problem Statement

4. (a) Show that $\langle \Phi | M | \Psi \rangle^* = \langle \Psi | M^\dagger | \Phi \rangle$, for any $|\Phi\rangle$ and $|\Psi\rangle$.
(b) Show that if $M|\Psi\rangle = \lambda|\Psi\rangle$ then $\langle \Psi | M^\dagger = \lambda^* \langle \Psi |$.
