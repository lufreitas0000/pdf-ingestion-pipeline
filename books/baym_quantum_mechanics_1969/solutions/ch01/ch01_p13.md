---
problem_id: baym_quantum_mechanics_1969_ch01_p13
...
**Source**: Chapter 1, Problem 13

## Problem Statement

13. What is the condition on the length of the calcite that, for frequency $\omega$, $|\Psi_{\text{out}}\rangle$ is always, to within a phase factor, the same state as $|\Psi_{\text{in}}\rangle$.
