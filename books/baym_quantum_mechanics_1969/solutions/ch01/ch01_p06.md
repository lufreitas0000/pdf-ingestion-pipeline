---
problem_id: baym_quantum_mechanics_1969_ch01_p06
...
**Source**: Chapter 1, Problem 6

## Problem Statement

6. (a) Show that the matrix $|\Phi\rangle\langle\Phi|$ is Hermitian.
(b) Show that the photon spin operator S is Hermitian. Generally all physical quantities are represented by Hermitian matrices.
